...
export const config = {
    ...
    // Config for tencentyun COS (https://cloud.tencent.com/product/cos) when storageType value is "tencentcloud".
    tencentcloud: {
    ...
    // Config for Huawei OBS (https://support.huaweicloud.com/sdk-nodejs-devg-obs/obs_29_0402.html) when storageType value is "obs".
    obs: {
        ...
        endpoint: process.env.OBS_BUCKET_NAME,
        downloadUrl : process.env.OBS_DOWNLOAD_URL || process.env.DOWNLOAD_URL
    },
